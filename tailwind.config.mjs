  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        'sharp-grotesk-book-25': ['Sharp Grotesk Book 25', 'Sharp Grotesk', 'system-ui', '-apple-system', 'sans-serif'],
        ...
        'sharp-grotesk-semibold-20': ['Sharp Grotesk SemiBold 20', 'Sharp Grotesk', 'system-ui', '-apple-system', 'sans-serif'],
